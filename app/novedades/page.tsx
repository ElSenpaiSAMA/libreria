...
import { fetchNewBooks, searchBooks, fetchBooksByCategory } from '@/lib/open-library-api';
    ...
    <div className="min-h-screen bg-stone-100">
      ...
      <section className="relative text-white py-24 md:py-32 overflow-hidden">
        ...
        <div 
          ...
          style={{
            backgroundImage: 'url(/hero-banners/hero-banner-novedades.jpg)',
          }}
        />
          ...
          <div className="flex items-center gap-6 mb-6">
            ...
            <div>
              ...
              <p className="text-xl md:text-2xl text-amber-100 mt-3 drop-shadow-md">
                Descubre los últimos lanzamientos - {filteredBooks.length} libros nuevos
              </p>
            </div>
          </div>
        </div>
      ...
      <main className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-6">
          <h3 className="text-2xl font-bold text-gray-900 mb-2">
            {selectedCategory === 'Todos' ? 'Todas las Novedades' : `Novedades en ${selectedCategory}`}
          </h3>
        ...
        {loading ? (
          ...
          <BookGrid
            ...
            emptyMessage={
              searchQuery
                ? `No se encontraron novedades que coincidan con "${searchQuery}"`
